...
using SharedPhotoAlbum.Api.Filters;
...
namespace SharedPhotoAlbum.Api
{
    public class Startup
    {
        ...
        private readonly string _allowFrontEnd = "_allowFrontEnd";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy(name: _allowFrontEnd,
                    builder =>
                    {
